...
export default function AdminDashboard(){
  ...
  async function saveSelected(){
    ...
    try{
      ...
      await uploadSelectedPhotos();setPhotoFiles([]);await loadSightings();setNotice('Sighting details updated.');
    }
